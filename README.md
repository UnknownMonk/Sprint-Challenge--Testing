...
# describe is used to wrap a entire component or function that is being tested and it() is used to run the individual test on said component or function.

1. What is the point of `Test Driven Development`? What do you think about this approach?

# TDD is a way to consepulize a project and its functionalty befor you write any code for it. Doing this results in cleaner code and fewer bugs. What I think about this approach is it is the proper way to handle development in a production enviorment.

1. Mention three types of automated tests.
   #Unit test End to end test and Intergration test
